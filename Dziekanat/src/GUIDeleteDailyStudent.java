...
public class GUIDeleteDailyStudent extends JDialog {
	...
	public static void main(String[] args) {
		try {
			GUIDeleteDailyStudent dialog = new GUIDeleteDailyStudent();
	...
	public GUIDeleteDailyStudent() {
		...
		for (int i = 0; i < Student.dailyStudentList.size(); i++) {
				...
				JLabel lblNazwa1 = new JLabel(Student.dailyStudentList.get(i).getName());
				...
				JLabel lblOznaczenie1 = new JLabel(Student.dailyStudentList.get(i).getSurname());
				...
				JLabel lblPesele = new JLabel(Integer.toString(Student.dailyStudentList.get(i).getPesel()));
				...
				JLabel lblIndeksy = new JLabel(Integer.toString(Student.dailyStudentList.get(i).getStudentId()));
		...
		JLabel lblUsuwanieStudentaDziennego = new JLabel("Usuwanie studenta dziennego");
