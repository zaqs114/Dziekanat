...
public class GUIDeleteMathEmployee extends JDialog {
	...
	public static void main(String[] args) {
		try {
			GUIDeleteMathEmployee dialog = new GUIDeleteMathEmployee();
	...
	public GUIDeleteMathEmployee() {
		...
		for (int i = 0; i < Employee.mathEmployeeList.size(); i++) {
				...
				JLabel lblNazwa1 = new JLabel(Employee.mathEmployeeList.get(i).getName());
				...
				JLabel lblOznaczenie1 = new JLabel(Employee.mathEmployeeList.get(i).getSurname());
				...
				JLabel lblPesele = new JLabel(Integer.toString(Employee.mathEmployeeList.get(i).getPesel()));
				...
				JLabel lblPlace = new JLabel(Integer.toString(Employee.mathEmployeeList.get(i).getSalary()));
		...
		JLabel lblUsuwanieStudentaDziennego = new JLabel("Usuwanie matematyka");
